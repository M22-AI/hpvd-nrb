...
** HPVD Knowledge Retrieval Engine | NRB Components | Deterministic Attestation* *
...
HPVD is a * *knowledge retrieval engine* * that runs in the * *NRB (Non-Binding Realm) * * in the * *Manithy v1 — Deterministic Attestation* * system. The main role of HPVD is to retrieve relevant Policy, Product, Rule Mapping, and Document Schema from the Knowledge Layer, based on __ code_0__ generated by the Parser.
...
- * *Traceable: * * Each candidate includes __ code_0 __ (data source).

HPVD consists of two layers:
- * *Primary: * *__ code_0 __ -sector filter + field matching → Policy/Product/RuleMapping candidates
- * *legacy: * *__ code_0 __ — analog search for OHLCV market data (still valid, not primary interface)
...
| Files | Contents |
|------|-----|
| [docs/HPVD_CORE.md] (docs/HPVD_CORE.md) | Technical reference: knowledge schemas, retrieval pipeline, input/output contracts, APIS |
...
Full pinned deps: __ code_0__ | editable install: __ code_1__
